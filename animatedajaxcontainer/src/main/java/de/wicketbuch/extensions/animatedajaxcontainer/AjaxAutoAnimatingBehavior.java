...
public class AjaxAutoAnimatingBehavior extends Behavior
{
	...
	public void onConfigure(Component component)
	{
		...
		if (ajax != null)
		{
			...
			else
			{
				if (component.isVisible())
				{
					component.add(DISPLAY_NONE_APPENDER);
	...
	static final Behavior DISPLAY_NONE_APPENDER = new DisplayNoneAppender();

	private static class DisplayNoneAppender extends AttributeAppender
	{
		private DisplayNoneAppender()
		{
